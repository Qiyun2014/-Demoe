...
/*!
 @abstract		For setting VR interactive mode. 0: Touch Mode; 1:Motion Mode
*/
@property(nonatomic)        int interactiveMode;

/*!
 @abstract		For setting VR display mode. 0: Normal Mode; 1:Glass Mode
 */
@property(nonatomic)        int displayMode;

/*!
 @method		For initial VR player
 @abstract		Setup and configure VR module
 @param			vc
 An viewcontroller for response touch event and motion event
 @param			view
 An view for show player window
 @result
 */
-(void) setupVRModule:(UIViewController*)vc view:(UIView*)view;

/*!
 @method		Get cache size
 @abstract		Get cache size
...
IJK_EXTERN NSString *const IJKMPMoviePlayerCompNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerUrlFetchDataTimeNotification;
@end
