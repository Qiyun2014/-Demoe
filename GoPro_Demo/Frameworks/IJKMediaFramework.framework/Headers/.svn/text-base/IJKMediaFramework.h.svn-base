...
#define IJKMPMoviePlayerCompNotification IJKMPMoviePlayerCompNotification
#define IJKMoviePlayerUrlFetchDataTimeNotification IJKMPMoviePlayerUrlFetchDataTimeNotification